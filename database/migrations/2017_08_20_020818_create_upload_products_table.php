...
class CreateUploadProductsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Upload_products", 'upload_products', 'file_name', 'fa-cloud-upload', [
            ["file_name", "File", "File", false, "", 0, 0, true],
            ["status", "Status", "TextField", false, "pending", 0, 256, true],
            ["file_import_status", "File Import Status", "TextField", false, "", 0, 256, false],
        ]);

...
<head>
    ...
    <meta name="author" content="Bosco IT Solutions">
    ...
    <meta property="og:sitename" content="boscoAdmin" />
	
    
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:site" content="@boscoadmin" />
    <meta name="twitter:creator" content="@boscoadmin" />
...
<div id="features">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-7">
				<h3 class="feature-title">What is Admin ?</h3><br>
				<ol class="features">
				...
				<h3 class="feature-title">Why Admin ?</h3><br>
                <ol class="features">
					<li><strong>Philosophy:</strong> Inspired by phpCMS &amp; based on Advanced <strong>Data Types</strong> like Image, HTML, File, Dropdown, TagInput which makes developers job easy. See more in <a target="_blank" href="#">features</a></li>
...
<div id="footerwrap">
    <div class="container">
        <div class="col-lg-5">
            ...
            <p>
				distinop, road,<br/>
				Web Development & solution Company,<br/>
                B4, strret 15,<br/>
                Melburn,<br/>
                Australia
            </p>
			<div class="contact-link"><i class="fa fa-envelope-o"></i> <a href="mailto:hello@example.com">hello@example.com</a></div>
			<div class="contact-link"><i class="fa fa-cube"></i> <a href="http://example.com">example.com</a></div>
			<div class="contact-link"><i class="fa fa-building"></i> <a href="http://example.com">example.com</a></div>
        </div>
...
<div id="c">
    <div class="container">
        <p>
            <strong>Copyright &copy; 2016. Powered by <a href="https://example.com"><b>example IT Solutions</b></a>
        </p>
    </div>
</div>
